    ...
    const views = {
      0: (
        <SwiperTab
          ...
          updateDescriptionView={this.updateDescriptionView}
      ...
      >
        ...
        >
          <Pressable
            ...
            style={view === 0 ? styles.highlighter : {}}
          >
            <Image
          ...
          <Pressable
            ...
            style={view === 1 ? styles.highlighter : {}}
          >
            <Image
              defaultSource={require("../assets/default/icon.png")}
              style={{ width: 30, height: 30 }}
              source={require("../assets/icons/icons8-star-48.png")}
            />
          </Pressable>
          <Pressable
            onPress={() => this.changeView(2)}
            style={view === 2 ? styles.highlighter : {}}
          >
            <Image
              style={{ width: 30, height: 30 }}
              source={require("../assets/icons/icons8-chat-bubble-100.png")}
            />
          </Pressable>
          <Pressable
            onPress={() => this.changeView(3)}
            style={view === 3 ? styles.highlighter : {}}
          >
            <Image
              style={{ width: 30, height: 30 }}
        ...
        <View style={{ flex: 12, marginTop: -20 }}>{views[view]}</View>
      </View>
    );
  }
}
