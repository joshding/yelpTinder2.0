...
import { StyleSheet, Button, Alert, View, Dimensions, ImageBackground , Image, SafeAreaView, Text, Pressable, TouchableOpacity} from 'react-native';
...
export default FavoritesView = ({changeView}) => {
  console.log('back in favorites view')
  return (
  <View
      style ={{
        backgroundColor: "#fff",
      ...
      >
        ...
        <SafeAreaView  style={{
          flex: 1, flexDirection: "row", flexWrap: "wrap", justifyContent: "space-evenly"}}>
            <TouchableOpacity onPress={() => {console.log('hi'); changeView(1)}} pressRetentionOffset={100}>
